...
class UsuariosExport implements FromArray, ShouldAutoSize, WithStyles, WithColumnWidths
{
    use Exportable;
    protected $tipo;
    ...
    public function array(): array
    {
        $array = [];
        $array[] =  [
            'Id', 'Nombre', 'Apellido', 'Tipo documento', 'Documento', 'Telefono', 'Correo',
            'Direccion', 'Nombre de usuario', 'Cargo', 'Estado'
        ];
