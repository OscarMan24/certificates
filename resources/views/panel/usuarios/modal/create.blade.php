                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-12 col-12 mb-3">
                        ...
                        <input type="text" class="form-control @error('jobTitle') is-invalid @enderror"
                            placeholder="{{ __('Cargo') }}" wire:model.defer="jobTitle" wire:target="store"
                            wire:loading.attr="disabled">
                        @error('jobTitle')
                            <div class="invalid-feedback ">{{ $message }} </div>
                        @enderror
                    ...
                    <div class="col-lg-6 col-md-12 col-12 mb-3">
                        ...
                        <input type="text" class="form-control @error('nameUser') is-invalid @enderror"
                            placeholder="{{ __('Nombre de usuario') }}" wire:model.defer="nameUser" wire:target="store"
                            wire:loading.attr="disabled">
                        @error('nameUser')
                            <div class="invalid-feedback ">{{ $message }} </div>
                        @enderror
                    ...
                    <div class="col-md-6 col-12 mb-3">
                        ...
                        <input type="text" class="form-control @error('password') is-invalid @enderror"
                            wire:model.defer="password" wire:target="store" wire:loading.attr="disabled"
                    ...
                    <div class="col-12 mb-3">
                        ...
                        <input type="file" class="form-control @error('image') is-invalid @enderror"
                            accept="image/*" wire:model="image" wire:target="store" wire:loading.attr="disabled">
                        @error('image')
                            <div class="invalid-feedback ">{{ $message }} </div>
                        @enderror
                                ...
                                <div class="col-auto mb-3">
                                    <div class="custom-check" wire:key="rol-agg-{{ $loop->iteration }}">
                                        <input class="form-check-input @error('roles_user') is-invalid @enderror"
                                            type="checkbox" value="true" id="rol{{ $loop->iteration }}"
