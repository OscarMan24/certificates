    ...
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">{{ __('Editar representante legal') }}</h5>
                    ...
                    <div class="col-12 mb-3">
                        ...
                        @if ($signatureCurrent)
                            <div class="col-12 mb-2 mt-3 text-center justify-content-center row">
                                <span>{{ __('Imagen firma actual') }}</span>
                                <img class="img-fluid "
                                    src="{{ asset('/storage/representantes/' . $signatureCurrent) }}"
