    ...
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">{{ __('Editar horario') }}</h5>
            ...
            <div class="modal-body">
               <div class="row">
                    <div class="col-lg-6 col-md-12 col-12 mb-3">
                        <span>{{ __('Tpo') }}</span>
                        <select class="form-control @error('type') is-invalid @enderror" wire:target="actualizar"
                    ...
                    <div class="col-lg-6 col-md-12 col-12 mb-3">
                        ...
                        <input type="number" class="form-control @error('timer') is-invalid @enderror" wire:model.defer="timer"
