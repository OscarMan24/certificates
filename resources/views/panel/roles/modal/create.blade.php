    ...
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">{{ __('Crear nuevo rol') }}</h5>
                ...
                <div class="row">
                    <div class="col-md-6 col-12 mb-4">
                        ...
                        <input type="text" class="form-control @error('name_rol') is-invalid @enderror"
                            placeholder="{{ __('Nombre') }}" wire:model.defer="name_rol" wire:target="store"
                    ...
                    <div class="col-12 mb-4">
                        <span class="mb-1">{{ __('Permisos disponibles') }} </span>
                        <div class="row">
