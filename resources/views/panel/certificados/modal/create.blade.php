    ...
    <div class="modal-dialog modal-dialog-centered modal-xl">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">{{ __('Crear nuevo certificado') }}</h5>
                        ...
                        <div class="col-12 row mb-3">
                            ...
                            <div class="col-lg-6 col-md-12 col-12 mb-3">
                                ...
                                <select class="form-control @error('asesorCertificado') is-invalid @enderror" readonly
                                    wire:target="store" wire:loading.attr="disabled" disabled
                                    wire:model.defer="asesorCertificado">
                                    <option value="">{{ __('Seleccione una opción') }}</option>
                        ...
                        <div class="col-12 row mb-3">
                            <div class="col-lg-6 col-md-12 col-12 mb-3">
                                ...
                                <select class="form-control @error('cursosId') is-invalid @enderror" wire:target="store"
                                    wire:loading.attr="disabled" wire:model.defer="cursosId">
                            ...
                            <div class="col-lg-6 col-md-12 col-12 mb-3">
                                ...
                                <select class="form-control @error('aliadoCertificado') is-invalid @enderror"
                                    wire:target="store" wire:loading.attr="disabled"
                            ...
                            <div class="col-lg-6 col-md-12 col-12 mb-3">
                                ...
                                <input type="date"
                                    class="form-control @error('fechaInicialCertificado') is-invalid @enderror"wire:model.defer="fechaInicialCertificado"
                                    wire:target="store" wire:loading.attr="disabled">
