    ...
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">{{ __('Editar aliado') }}</h5>
            ...
            <div class="modal-body">
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-12 col-12 mb-3">
                        ...
                        <select class="form-control @error('typeDocumentLegalRepresentative') is-invalid @enderror" wire:target="actualizar"
                    ...
                    <div class="col-lg-6 col-md-12 col-12 mb-3">
                        ...
                        <select class="form-control @error('economicSectorId') is-invalid @enderror" wire:target="actualizar"
                    ...
                    <div class="col-md-6 col-12 mb-2">
                        ...
                        <input type="text" class="form-control @error('arl_name') is-invalid @enderror"
                            placeholder="{{ __('Nombre arl') }}" wire:model.defer="arl_name" wire:target="actualizar"
                    ...
                    <div class="col-md-6 col-12 mb-2">
                        ...
                        <input type="text" class="form-control @error('address') is-invalid @enderror"
                            placeholder="{{ __('Direccion') }}" wire:model.defer="address" wire:target="actualizar"
                            wire:loading.attr="disabled">
                        @error('address')
                            <div class="invalid-feedback ">{{ $message }} </div>
                        @enderror
