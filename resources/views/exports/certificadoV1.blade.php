...
<body>
    ...
    <div class="certificado d-inline-flex" style="height: 99%; width: 100%; margin-top: 5px;">
        ...
        <div class="col-2" style="margin-left: 500px; margin-top: -5px"> 
            <h5 class="text-start"  >
                {{ $data['nombreAliado'] }}
            </h5>
        </div>
        <div class="col-2" style="margin-left: 800px; margin-top: -100px"> 
            <h5 class="text-start" >
                {{ $data['nitAliado'] }}
            </h5>
        </div>

        <div class="col-6" style="margin-left: 590px; margin-top: -10px"> 
            <h5 class="text-start" >
                {{ $data['representanteLegalAliado'] }}
            </h5>
        </div>

        <div class="col-3"  style="margin-left: 500px; margin-top: -10px"> 
            <h5 class="text-start" >
                {{ $data['economicSector'] }}
            </h5>
        </div>
        ...
        <h2 class="justify-content-center text-center  "
            style=" margin-top:50px; font-wight: 800; font-size: 44px ">
            {{ $data['nombre_curso'] }}
        </h2>
        ...
        <h5 class="justify-content-center  "
          style="margin-left: 678px; font-wight: 600; font-size:14px; margin-top:-9px">
            {{ $data['horas'] }}
        </h5>
        <h5 class="justify-content-center  "
            style="margin-left: 879px; font-wight: 600; font-size:14px; margin-top:10px">
