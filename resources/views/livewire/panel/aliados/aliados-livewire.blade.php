<div wire:init="loadData">
    <div class="row">
        <div class="col">
            <div class="card">
                <div class="card-body">
                    <h5 class="card-title">{{ __('Aliados') }}
                        @can('aliado.store')
                    ...
                    <div class="row col-12 mb-4">
                        <div class="col-lg-3 col-md-4 col-12 mb-2">
                            <span>{{ __('Buscar aliado') }}</span>
                            <input type="search" class="form-control @error('search') is-invalid @enderror"
                                placeholder="{{ __('Buscar por nombre, documento, correo, representante y telefono') }}"
                                wire:model="search">
                            @error('search')
                        ...
                        <table class="table table-hover">
                            <thead>
                                <tr>
                                    ...
                                    @can(['aliado.edit', 'aliado.delete'])
                                        <th scope="col">{{ __('Accion') }}</th>
                                    @endcan
                                </tr>
                            </thead>
                            <tbody>
                                @forelse ($this->Aliados as $item)
                                    <tr>
    ...
    @include('panel.aliados.modal.create')
    @include('panel.aliados.modal.edit')
    @include('panel.aliados.modal.export')
